package id.ac.polinema.absenguru.helper;
...
public class Session {
    ...
    private static final String NIM_PREF = "nim";
    private static final String NAMA_PREF = "nama";
    private static final String KELAS_PREF = "kelas";
    ...
    public void setNim(String nim) {
        preferences.edit().putString(NIM_PREF, nim).apply();
    }

    public String getNim() {
        return  preferences.getString(NIM_PREF, "");
    }

    public void setNama(String nama) {
        preferences.edit().putString(NAMA_PREF, nama).apply();
    }

    public String getNama() {
        return  preferences.getString(NAMA_PREF, "");
    }

    public void setKelas(String kelas) {
        preferences.edit().putString(KELAS_PREF, kelas).apply();
    }

    public String getKelas() {
        return  preferences.getString(KELAS_PREF, "");
    }
